...
class Telefono(models.Model):
    ...
    codigoArea = models.ForeignKey(CodigoArea, on_delete=models.RESTRICT, related_name='telefonos')
...
class DetalleCategoria(models.Model):
    categoria = models.ForeignKey(CategoriaBombero, on_delete=models.RESTRICT, related_name='detallesCategoria')
    actividad = models.ForeignKey(Actividad, on_delete=models.RESTRICT, related_name='detalleCategoria')
...
class BomberoUser(AbstractBaseUser, PermissionsMixin):
    ...
    telefono = models.ForeignKey(Telefono, on_delete=models.RESTRICT, related_name='bombero', null=True, blank=True)
    categoria = models.ForeignKey(CategoriaBombero, on_delete=models.RESTRICT, related_name='bomberos', null=True, blank=True)
